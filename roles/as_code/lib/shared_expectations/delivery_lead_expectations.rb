class DeliveryLeadExpectations < JobSpec::Role::Expectations
  expected 'be the point of contact for the customer',
  ...
  expected 'ensure the team collaborates, communicates and focuses on what is most important',
