class OperationsCoordinatorExpectations < JobSpec::Role::Expectations
 expected 'to report on and maintain team utilisation at > 85%',
  ...
  expected 'to control resource allocation and forecasting across the organisation',
  ...
  expected 'to manage our engagements with third party contractors',
  ...
  expected 'to manage resource allocation with third party partners',
  ...
  expected 'to deliver special projects',
