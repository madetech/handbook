...
JobSpec::Role.definition 'Academy Engineer' do
  ...
  expected "To continuously practicing TDD, including small incremental refactorings throughout the process of delivering software, with the intent to ensure low cost of change", 
  ...
  expected "To be working towards achieving the Made Tech Core Skills", 
